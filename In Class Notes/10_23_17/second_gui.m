...
% SECOND_GUI MATLAB code for second_gui.fig
...
% Last Modified by GUIDE v2.5 23-Oct-2017 11:11:43
...
% --- Executes on button press in change_text_button.
function change_text_button_Callback(hObject, eventdata, handles)
% hObject    handle to change_text_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.text2.String = 'Second String';
guidata(hObject, handles);